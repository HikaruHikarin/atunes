...
final class SubstanceLookAndFeelTableCellRenderer extends
	...
	SubstanceLookAndFeelTableCellRenderer(final ITableCellRendererCode code) {
		this.code = code;
	}
	...
	public JComponent getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected, final boolean hasFocus, final int row, final int column) {
		...
		return this.code.getComponent(c, table, value, isSelected, hasFocus,row, column);
